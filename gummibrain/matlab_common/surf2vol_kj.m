...
img=surf2volz_kj(node(:,1:3),face(:,1:3),xi,yi,zi);
img=img | shiftdim(surf2volz_kj(node(:,[3 1 2]),face(:,1:3),zi,xi,yi),1);
img=img | shiftdim(surf2volz_kj(node(:,[2 3 1]),face(:,1:3),yi,zi,xi),2);
