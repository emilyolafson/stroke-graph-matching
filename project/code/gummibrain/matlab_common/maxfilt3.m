function B = maxfilt3(A,siz,padopt,CHUNKFACTOR)

%MEDFILT3 1-D, 2-D and 3-D maximum filtering.
...
existNaNmedian = exist('nanmax','file');
...
for i = 1:length(nchunk)-1
    ...
    if existNaNmedian
        B(nchunk(i):nchunk(i+1)) = nanmax(A(I0),[],2);
    else
