...
%   - Now writes data type of content as element attribute
%       example: s.XMLname.SomeNumber = [6 7 8];
%       produces: <SomeNumber datatype="double">6 7 8</SomeNumber>
        ...
        elseif (strcmp(curfield,'Text'))
            ...
            elseif (iscell(s.(curfield)))
                ...
                if (succes)
                    ...
                    valtype=class(s.(curfield));
                    curElement.setAttribute('datatype',valtype);
                else
                    disp(['Warning. The text in ' pName curfield ' could not be processed.']);
                end
            end
