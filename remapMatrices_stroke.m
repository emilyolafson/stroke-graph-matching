...
%% calculate the sum of remap frequencies within each yeo network. use as input to GLM
...
all_sums_s2s3=yeonetwork_remaps(norm_s3_s2_freq);
all_sums_s3s4=yeonetwork_remaps(norm_s4_s3_freq);
