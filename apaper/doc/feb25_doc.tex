...
\section*{Discussion}
	...
	The results were consistent across increasing penalization for swaps farther apart in MNI space, despite the associated reductions in the number of swaps overall. Suggesting that remapping with more proximal nodes (specifically in the ipsilesional hemisphere) contribute to recovery and impairment
...
\begin{figure}[h] % precision matrix regularization
	\begin{center}
		\includegraphics[width=0.6\textwidth]{precision_fullFCs.png}
...
\begin{figure}[h] %\label{sumremaps_yeo}
		...
		\caption{Sum of remaps within 8 functional networks}
		\centering
		\label{sumremaps_yeo}
\end{figure}
...
\begin{figure}[h] %sum of remaps within each ofr hte 8 functional netowrks
	\includegraphics[width=0.9\textwidth]{beta_nswaps.png}
